...
async function loadWordCounts(): Promise<Record<string, number>> {
  ...
  const [
    ...
    import("@/lib/word-library-extra16a"),
    import("@/lib/word-library-extra16b"),
    import("@/lib/word-library-extra16c"),
    import("@/lib/word-library-extra16d"),
    import("@/lib/word-library-extra16e"),
    import("@/lib/word-library-extra16f"),
    import("@/lib/word-library-extra16g"),
    import("@/lib/word-library-extra16h"),
    import("@/lib/word-library-extra17"),
    import("@/lib/word-library-extra18"),
