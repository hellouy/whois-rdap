...
export const STATUS_MAPPING: Record<string, StatusInfo> = {
  ...
  // ========== 不规则/ccTLD 特殊状态 ==========
  'connect': { chinese: '已连接', description: '域名已连接', category: 'normal', severity: 'info' },
  'linked': { chinese: '已关联', description: '域名已关联', category: 'normal', severity: 'info' },
  'associated': { chinese: '已关联', description: '域名已关联', category: 'normal', severity: 'info' },
  'registered': { chinese: '已注册', description: '域名已注册', category: 'normal', severity: 'info' },
  'notassigned': { chinese: '未分配', description: '域名未分配', category: 'other', severity: 'info' },
  'assigned': { chinese: '已分配', description: '域名已分配', category: 'normal', severity: 'info' },
  'published': { chinese: '已发布', description: '域名已发布', category: 'normal', severity: 'info' },
  'verified': { chinese: '已验证', description: '域名已验证', category: 'normal', severity: 'info' },
  'validated': { chinese: '已验证', description: '域名已通过验证', category: 'normal', severity: 'info' },
  'thedomainisn\'tgeneratedinthezone': { chinese: '未生成DNS区域', description: '该域名未在DNS区域中生成', category: 'hold', severity: 'warning' },
  'notgeneratedinthezone': { chinese: '未生成DNS区域', description: '未在DNS区域中生成', category: 'hold', severity: 'warning' },
  'zone': { chinese: 'DNS区域', description: 'DNS区域相关', category: 'other', severity: 'info' },
  'generated': { chinese: '已生成', description: '已在区域中生成', category: 'normal', severity: 'info' },
  'delegated': { chinese: '已委托', description: '域名已委托', category: 'normal', severity: 'info' },
  'notdelegated': { chinese: '未委托', description: '域名未委托', category: 'hold', severity: 'warning' },
  'undelegated': { chinese: '未委托', description: '域名未委托', category: 'hold', severity: 'warning' },
  'exempt': { chinese: '豁免', description: '域名豁免', category: 'other', severity: 'info' },
  'renewgrace': { chinese: '续费宽限期', description: '续费后宽限期', category: 'grace', severity: 'info' },
  'pendingreview': { chinese: '审核中', description: '域名审核中', category: 'pending', severity: 'warning' },
  'pendingactivation': { chinese: '待激活', description: '域名待激活', category: 'pending', severity: 'warning' },
  'pendingsuspension': { chinese: '待暂停', description: '域名待暂停', category: 'pending', severity: 'warning' },
  'pendingtransit': { chinese: '待转移', description: '域名待转移', category: 'pending', severity: 'warning' },
  'free': { chinese: '空闲', description: '域名空闲可用', category: 'other', severity: 'info' },
  'taken': { chinese: '已被注册', description: '域名已被注册', category: 'normal', severity: 'info' },
  'parked': { chinese: '已停放', description: '域名已停放', category: 'other', severity: 'info' },
  'outofservice': { chinese: '停止服务', description: '域名已停止服务', category: 'hold', severity: 'error' },
  'disabled': { chinese: '已禁用', description: '域名已禁用', category: 'hold', severity: 'error' },
  'tobereleased': { chinese: '待释放', description: '域名待释放', category: 'delete', severity: 'warning' },
  'released': { chinese: '已释放', description: '域名已释放', category: 'delete', severity: 'info' },
  'disputed': { chinese: '争议中', description: '域名存在争议', category: 'hold', severity: 'error' },
  'court': { chinese: '法院限制', description: '法院限制域名', category: 'hold', severity: 'error' },
  'renewal': { chinese: '续费中', description: '域名续费中', category: 'renew', severity: 'info' },
  'grace': { chinese: '宽限期', description: '域名宽限期', category: 'grace', severity: 'info' },
  'tobepurged': { chinese: '待清除', description: '域名待清除', category: 'delete', severity: 'error' },
  'purged': { chinese: '已清除', description: '域名已清除', category: 'delete', severity: 'error' },
  'archived': { chinese: '已归档', description: '域名已归档', category: 'other', severity: 'info' },
  'notrenewed': { chinese: '未续费', description: '域名未续费', category: 'renew', severity: 'warning' },
  'nottransferrable': { chinese: '不可转移', description: '域名不可转移', category: 'lock', severity: 'info' },
  'notregistrable': { chinese: '不可注册', description: '域名不可注册', category: 'other', severity: 'warning' },
};
