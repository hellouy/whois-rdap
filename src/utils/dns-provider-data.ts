...
export const DNS_PROVIDERS: Record<string, DnsProviderInfo> = {
  ...
  'azure-dns': { name: 'Azure DNS', url: 'https://azure.microsoft.com/products/dns' },
  ...
  'googledomains': { name: 'Google Domains (Squarespace)', url: 'https://www.squarespace.com' },
  ...
  'ultradns': { name: 'UltraDNS (Vercara)', url: 'https://vercara.com/ultradns' },
  'ns1': { name: 'NS1 (IBM)', url: 'https://www.ibm.com/ns1-connect' },
  ...
  'linode': { name: 'Linode (Akamai)', url: 'https://www.linode.com' },
  ...
  'dnsowl': { name: 'NameSilo', url: 'https://www.namesilo.com' },
  ...
  'spaceship': { name: 'Spaceship', url: 'https://www.spaceship.com' },

  // 中国
  'dnspod': { name: 'DNSPod (腾讯云)', url: 'https://www.dnspod.cn' },
  'tencentyun': { name: '腾讯云 DNS', url: 'https://cloud.tencent.com/product/cns' },
  'tencentdns': { name: '腾讯云 DNS', url: 'https://cloud.tencent.com/product/cns' },
  'aliyun': { name: '阿里云 DNS', url: 'https://www.aliyun.com/product/dns' },
  'alidns': { name: '阿里云 DNS', url: 'https://www.aliyun.com/product/dns' },
  'hichina': { name: '万网 (阿里云)', url: 'https://wanwang.aliyun.com' },
  'net.cn': { name: '万网 (阿里云)', url: 'https://wanwang.aliyun.com' },
  'huaweicloud': { name: '华为云 DNS', url: 'https://www.huaweicloud.com/product/dns.html' },
  'hwclouds-dns': { name: '华为云 DNS', url: 'https://www.huaweicloud.com/product/dns.html' },
  ...
  'arvancloud': { name: 'ArvanCloud', url: 'https://www.arvancloud.ir' },
  'nsone': { name: 'NS1 (IBM)', url: 'https://www.ibm.com/ns1-connect' },
  'dynv6': { name: 'dynv6', url: 'https://dynv6.com' },
  'duckdns': { name: 'Duck DNS', url: 'https://www.duckdns.org' },
  'eurodns': { name: 'EuroDNS', url: 'https://www.eurodns.com' },
  'hostpoint': { name: 'Hostpoint', url: 'https://www.hostpoint.ch' },
  'infomaniak': { name: 'Infomaniak', url: 'https://www.infomaniak.com' },
  'one.com': { name: 'One.com', url: 'https://www.one.com' },
  'aruba': { name: 'Aruba', url: 'https://www.aruba.it' },
  'active24': { name: 'Active24', url: 'https://www.active24.com' },
  'loopia': { name: 'Loopia', url: 'https://www.loopia.se' },
  'simply.com': { name: 'Simply.com', url: 'https://www.simply.com' },
  'domainnameshop': { name: 'Domainnameshop', url: 'https://www.domainnameshop.com' },
  'webgo': { name: 'webgo', url: 'https://www.webgo.de' },
  'combell': { name: 'Combell', url: 'https://www.combell.com' },
  'openprovider': { name: 'Openprovider', url: 'https://www.openprovider.com' },
  'misaka': { name: 'Misaka', url: 'https://www.misaka.io' },
  'tencent': { name: '腾讯云', url: 'https://cloud.tencent.com' },
};
